                                ...
                                <div class="p-4">
                                	<form action="voucher" method="post">
	                                	 <div class="input-group mb-4 border rounded-pill p-2">
	                                        <input name="nameVoucher" type="text"  placeholder="Nhập Voucher" aria-describedby="button-addon3" class="form-control border-0">
	                                        <div class="input-group-append border-0">
	                                            <button id="button-addon3" type="submit" class="btn btn-dark px-4 rounded-pill"><i class="fa fa-gift mr-2"></i>Sử dụng</button>
	                                        </div>
	                                    </div>
                                	</form>
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>
                                            <h5 class="font-weight-bold">${sessionScope.sum} ₫</h5>
                                        </li>
